...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  if(empty($alertMessage)){
    ...
    $retail_price = test_input($_POST['retail_price']);
    $cost_price = test_input($_POST['cost_price']);
    $date_arr = test_input($_POST['date_arr']);

  //Checking the values are existing in the database or not
    $query = "INSERT INTO inventory (supplier_name, category, branch_name, product_description, model, po_number, qty, retail_price, cost_price, date_arr) VALUES ('$supplier_name', '$category', '$branch_name', '$product_description', '$model', '$po_number', '$qty', '$retail_price', '$cost_price', '$date_arr')";
